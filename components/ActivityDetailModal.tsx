...
export const ActivityDetailModal: React.FC<ActivityDetailModalProps> = ({ isOpen, onClose, activity, userAvatarMap = {} }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md">
            <div className="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl w-full max-w-xl animate-in fade-in zoom-in duration-300 overflow-hidden border border-white/20 dark:border-zinc-800 flex flex-col">
                <div className="flex justify-between items-center px-10 pt-10 pb-6 bg-gradient-to-b from-slate-50 to-white dark:from-zinc-800/50 dark:to-zinc-900">
                    <div className="flex items-center gap-4">
                        <UserAvatar name={activity.itPersonnel} url={userAvatarMap[activity.itPersonnel]} size="lg" className="ring-offset-4 ring-offset-white dark:ring-offset-zinc-900 ring-blue-500/20 shadow-xl" />
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-[10px] text-slate-400 dark:text-zinc-500 uppercase font-bold tracking-[0.2em]">IT Personnel</p>
                            </div>
                        </div>
                    </div>
                    <button onClick={onClose} className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all bg-white dark:bg-zinc-800 rounded-xl shadow-sm border border-slate-100 dark:border-zinc-700 active:scale-90">
                        <X size={20} />
                    </button>
                </div>
                ...
                <div className="px-10 pb-10">
                    <div className="mb-8">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <span className="px-3 py-1 bg-slate-100 dark:bg-zinc-800 text-slate-500 dark:text-zinc-400 text-[10px] font-black rounded-lg uppercase tracking-widest border border-slate-200 dark:border-zinc-700">
                                {activity.category}
                            </span>
                    ...
                    <div className="grid grid-cols-2 gap-6 bg-slate-50/50 dark:bg-zinc-800/30 p-8 rounded-xl border border-slate-100 dark:border-zinc-800/50">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-slate-400 dark:text-zinc-500 uppercase text-[9px] tracking-[0.2em] mb-0.5">Requester</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-slate-400 dark:text-zinc-500 uppercase text-[9px] tracking-[0.2em] mb-0.5">Department</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-slate-400 dark:text-zinc-500 uppercase text-[9px] tracking-[0.2em] mb-0.5">Plan / Starts</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-slate-400 dark:text-zinc-500 uppercase text-[9px] tracking-[0.2em] mb-0.5">Completion</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-slate-400 dark:text-zinc-500 uppercase text-[9px] tracking-[0.2em] mb-0.5">Location</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="font-bold text-slate-400 dark:text-zinc-500 uppercase text-[9px] tracking-[0.2em] mb-0.5">Total Duration</p>
                                <p className="text-slate-900 dark:text-slate-100 font-black text-sm uppercase tracking-tight">{activity.duration || 'N/A'}</p>
                            </div>
                        </div>

                        <div className="col-span-2 mt-2 pt-6 border-t border-slate-200/50 dark:border-zinc-700/50">
                            ...
                            <div className="p-6 bg-white dark:bg-zinc-900 rounded-xl border border-slate-100 dark:border-zinc-800 text-slate-600 dark:text-zinc-300 italic leading-relaxed text-[15px] shadow-sm font-medium relative overflow-hidden group">
