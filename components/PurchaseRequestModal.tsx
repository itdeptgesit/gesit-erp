            ...
            <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg w-full max-w-2xl animate-in fade-in zoom-in duration-300 flex flex-col max-h-[90vh] border border-slate-200 dark:border-zinc-800">
                ...
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                    <form id="purchaseForm" onSubmit={handleSubmit} className="space-y-6">
                        <div className="bg-blue-50/50 dark:bg-blue-900/10 p-5 rounded-lg border border-blue-100 dark:border-blue-900/30 flex items-center justify-between shadow-inner">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2 bg-slate-900 dark:bg-zinc-950 p-6 rounded-lg border border-white/5 flex justify-between items-center shadow-lg">
                                <div>
