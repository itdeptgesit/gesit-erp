...
}> = ({ ext, index, isAdmin, isFocused, onEdit, onDelete }) => {
                ...
                <div className="flex gap-2">
                    ...
                    {isAdmin && (
                        <div className="flex gap-1">
                            ...
                            <button onClick={() => onDelete?.(ext.id)} className="p-1.5 text-slate-400 hover:text-red-500 transition-colors"><Trash2 size={12} /></button>
                        </div>
                    )}
                </div>
            </div>
...
const ExtensionTable: React.FC<{
    ...
    onEdit?: (ext: PhoneExtension) => void;
    onDelete?: (id: number) => void;
}> = ({ extensions, isAdmin, onEdit, onDelete }) => {
