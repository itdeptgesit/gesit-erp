...
export const translations = {
  en: {
    ...
    // Phone Directory / Extension Directory & Sidebar
    dialingProtocol: 'Dialing Protocol',
    intercomGuide: 'Intercom Quick Guide',
    floor27CityTower: 'Floor 27 - The Gesit Companies',
    floor26GesitResources: 'Floor 26 - Gesit Natural Resources',
    pickupIncoming: 'Pickup Incoming',
    callTo26thFloor: 'Call to 26th Floor',
    callTo27thFloor: 'Call to 27th Floor',
    outgoingCall: 'Outgoing Call',
    internationalCall: 'International Call',
    extCopied: 'Copied',
    clickToCopyExt: 'Click to copy extension',
    floorLabel: 'Floor',
    allFloors: 'All Floors',
    searchDirectoryPlaceholder: 'Search by name, department, role, or extension...',
    gridMode: 'Grid Mode',
    tableMode: 'Table Mode',
    shareDirectory: 'Share Directory',
    exportPdf: 'Export PDF',
    uploadPhoto: 'Upload Photo',
    addingExtension: 'Add Extension',
    editingExtension: 'Edit Extension',
    deleteExtensionConfirm: 'Are you sure you want to delete this extension?',
    ...
    settingsAndSetup: 'Settings & Setup',
  ...
  id: {
    ...
    // Phone Directory / Extension Directory & Sidebar
    dialingProtocol: 'Protokol Panggilan',
    intercomGuide: 'Panduan Cepat Interkom',
    floor27CityTower: 'Lantai 27 - The Gesit Companies',
    floor26GesitResources: 'Lantai 26 - Gesit Natural Resources',
    pickupIncoming: 'Ambil Panggilan Masuk',
    callTo26thFloor: 'Panggilan ke Lantai 26',
    callTo27thFloor: 'Panggilan ke Lantai 27',
    outgoingCall: 'Panggilan Keluar',
    internationalCall: 'Panggilan Internasional',
    extCopied: 'Disalin',
    clickToCopyExt: 'Klik untuk menyalin ekstensi',
    floorLabel: 'Lantai',
    allFloors: 'Semua Lantai',
    searchDirectoryPlaceholder: 'Cari berdasarkan nama, departemen, jabatan, atau ekstensi...',
    gridMode: 'Mode Grid',
    tableMode: 'Mode Tabel',
    shareDirectory: 'Bagikan Direktori',
    exportPdf: 'Ekspor PDF',
    uploadPhoto: 'Unggah Foto',
    addingExtension: 'Tambah Ekstensi',
    editingExtension: 'Ubah Ekstensi',
    deleteExtensionConfirm: 'Apakah Anda yakin ingin menghapus ekstensi ini?',
    photoUrlLabel: 'URL Foto',
    pinLabel: 'Kode PIN',
    extensionLabel: 'Ekstensi',
    nameLabel: 'Nama',
    roleLabel: 'Jabatan',
    deptLabel: 'Departemen',
    floorFieldLabel: 'Lantai',
    saveExtension: 'Simpan Ekstensi',
    mainMenu: 'Menu Utama',
    administrationGroup: 'Administrasi',
    settingsAndSetup: 'Pengaturan & Konfigurasi',
    enterprisePlatform: 'Platform Perusahaan'
  }
};
